...
/**
 * 本地POI搜索介绍，主要对名称首字母和地址首字母查找进行使用介绍。
 */
public class LocalPoiLetterSearchActivity extends FragmentActivity implements View.OnClickListener,MapController.OnMarkerClickListener{
    private MapController lMap;
    private AutoCompleteTextView searchText;// 输入搜索首字母
    private String keyWord = "";// 要输入的poi搜索首字母
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_localsearchletter);
        getSnPath();
        getDataPath();
        init();
    ...
    public void searchButton() {
        ...
        if ("".equals(keyWord)) {
            ToastUtil.show(LocalPoiLetterSearchActivity.this, "请输入搜索关键字");
            return;
        } else {
            doSearchQuery();
        }
    ...
    public void nextButton() {
        if (query != null && poiSearch != null && poiResult != null) {
            if (poiResult.getPageCount()  > currentPage) {
                ...
                ToastUtil.show(LocalPoiLetterSearchActivity.this,
    ...
    private void setUpMap() {
        ...
        spinner_searchTypes = (Spinner) findViewById(R.id.spinner_firstletter_types);
        spinner_searchTypes.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                switch (pos)
                {
                    ...
                    case 0:
//                        searchType = SearchType.SEARCH_TYPE_POIFIRSTLETTER;
                        break;
                    case 1:
//                        searchType = SearchType.SEARCH_TYPE_ADDRFIRSTLETTER;
                        break;
                    default:
                        break;
                }
